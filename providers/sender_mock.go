...
type SenderMock struct {
	...
	funcSend          func(ctx context.Context, email Email) (err error)
	inspectFuncSend   func(ctx context.Context, email Email)
...
func (mmSend *mSenderMockSend) Inspect(f func(ctx context.Context, email Email)) *mSenderMockSend {
...
func (mmSend *mSenderMockSend) Set(f func(ctx context.Context, email Email) (err error)) *SenderMock {
	if mmSend.defaultExpectation != nil {
...
// Then helper
func (mmSend *mSenderMockSend) When(ctx context.Context, email Email) *SenderMockSendExpectation {
	if mmSend.mock.funcSend != nil {
		mmSend.mock.t.Fatalf("SenderMock.Send mock is already set by Set")
	}
	...
	expectation := &SenderMockSendExpectation{
		mock:   mmSend.mock,
		params: &SenderMockSendParams{ctx, email},
	}
...
func (mmSend *SenderMock) Send(ctx context.Context, email Email) (err error) {
	...
	if mmSend.inspectFuncSend != nil {
		mmSend.inspectFuncSend(ctx, email)
	}

	mm_params := &SenderMockSendParams{ctx, email}
	...
	if mmSend.SendMock.defaultExpectation != nil {
		...
		mm_got := SenderMockSendParams{ctx, email}
	...
	if mmSend.funcSend != nil {
		return mmSend.funcSend(ctx, email)
	}
	mmSend.t.Fatalf("Unexpected call to SenderMock.Send. %v %v", ctx, email)
	return
}
